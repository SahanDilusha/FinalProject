...
public class Form_Dashboard extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        card1 = new acc.card.Card();
        card2 = new acc.card.Card();
        card3 = new acc.card.Card();
        roundPanel1 = new acc.swing.RoundPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        table = new acc.swing.table.Table();
    ...
    private acc.card.Card card1;
    private acc.card.Card card2;
    private acc.card.Card card3;
    private javax.swing.JScrollPane jScrollPane1;
    private acc.swing.RoundPanel roundPanel1;
    private acc.swing.table.Table table;
